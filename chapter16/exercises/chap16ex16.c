 ...
 *
 * a) An enumeration constants may represent any integer specified by the
 *    programmer. -- True

 * b) Enumeration constants have exactly the same properties as constants
 *    created using #define. --False
 *    Enumerations can have function / block scope unlike #define constants.
 *
 ...
 *
 * e) Enumeration constants may be used as integers in expressions. -- True
 *
*/
